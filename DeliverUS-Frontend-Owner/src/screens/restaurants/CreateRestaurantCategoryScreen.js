...
import { create, createCategory, getRestaurantCategories } from '../../api/RestaurantEndpoints'
  ...
  const validationSchema = yup.object().shape({
    ...
    const createRestaurant = async (values) => {
      ...
      try {
        ...
        showMessage({
          message: `Restaurant Category ${createdRestaurant.name} succesfully created`,
          type: 'success',
